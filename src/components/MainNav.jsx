    ...
    <Con className={mobilepop === "close" ? "float" : ""}>
      <div className={mobilepop === "close" ? "content pop" : "content"}>
        ...
        <IoIosCall style={{position:"relative", top:"5px", fontSize:"1.7rem"}}/>
          ...
          <div className="soc">
            <a style={{color:"#fff",position:"relative", top:"3px",}}href="https://www.facebook.com/industrymoverscorporation">
  ...
  & .nav {
    ...
    & .navs {
      ...
      &.active {
        color: #ffc96c;
        font-weight: bold;
        border-bottom: 3px solid #ffc96c;
      }
      &:hover {
        color: #cca96d;
